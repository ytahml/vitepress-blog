...
![instanceKlass对象](assets/03_类的生命周期/1773839411237.png)
...
![方法区和堆区](assets/03_类的生命周期/1773840373194.png)
...
![1773842296443](assets/03_类的生命周期/1773842296443.png)

使用了 sudo 授权依旧出现了连接错误，可能需要关闭 Mac 的 SIP ，暂时跳过

![1773843846465](assets/03_类的生命周期/1773843846465.png)
...
![Pasted image 20260319213937.png](assets/03_类的生命周期/Pasted%20image%2020260319213937.png)

若修改文件头的字节，则 Java 没有办法再识别 Class 文件；

![1773928010765](assets/03_类的生命周期/1773928010765.png)

2. 元信息验证，例如类必须要有父类（super 不能为空）；

![1773928243833](assets/03_类的生命周期/1773928243833.png)
...
![1773928788940](assets/03_类的生命周期/1773928788940.png)

准备阶段只会给静态变量赋初值，基本数据类型和引用数据类型都有初始值；

![1773928920798](assets/03_类的生命周期/1773928920798.png)

为了避免静态变量指向的内存区域之前有残留的随机值，因此需要设置初始值；

如果静态变量是 final 修饰的常量，则会再准备阶段直接将代码中的值进行赋值：

![1773929136249](assets/03_类的生命周期/1773929136249.png)
...
![1774059645738](assets/03_类的生命周期/1774059645738.png)

颠倒静态代码块和静态变量初始化的代码顺序后，字节码指令也会随之颠倒；

![1774059864024](assets/03_类的生命周期/1774059864024.png)
